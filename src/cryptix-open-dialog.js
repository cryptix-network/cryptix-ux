import {html, css, CryptixDialog, i18n, T} from './cryptix-dialog.js';
import {askForPassword, baseUrl} from "./wallet.js";
const pass = "";

class CryptixOpenDialog extends CryptixDialog{
	...
	renderOpenUI(){
		...
		return html`
			${this.hideLogo?'': html`
			<div>
				<img class="big-logo" src="${baseUrl+'/resources/images/cryptix.png'}" />
			</div>`}
...
CryptixOpenDialog.define("cryptix-open-dialog");
