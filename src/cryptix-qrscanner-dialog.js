...
class CryptixQRScannerDialog extends CryptixDialog{
	...
	static get styles(){
		return [CryptixDialog.styles, css`
			.container{
				...
				max-height:var(--cryptix-dialog-container-max-height, 620px);
			}
...
CryptixQRScannerDialog.define("cryptix-qrscanner-dialog");
