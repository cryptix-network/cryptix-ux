import {html, css, FlowFormat, i18n, T} from './cryptix-wallet-ui.js';
import {CryptixWalletMobile} from './cryptix-wallet-mobile.js';

export class CryptixWalletDesktop extends CryptixWalletMobile{
	...
	static get styles(){
		return [CryptixWalletMobile.styles, css`
			:host{overflow:hidden}
			.container{
				padding:var(--cryptix-wallet-container-padding, 15px);
			...
			.right-area{
				...
				height:var(--cryptix-wallet-right-area-height, calc(100vh - 122px));
			...
			.top-menu{
				...
				position:var(--cryptix-wallet-top-menu-position, absolute);
				right:var(--cryptix-wallet-top-menu-right, 20px);
				top:var(--cryptix-wallet-top-menu-top, -4px);
				z-index:2;
